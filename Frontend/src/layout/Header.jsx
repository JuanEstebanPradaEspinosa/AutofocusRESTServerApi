...
export default function Header() {
  return (
    <Disclosure as="nav" className="bg-gray-800 p-4">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-8xl px-2 sm:px-2 lg:px-6">
            <div className="relative flex h-16 items-center justify-between">
              ...
              {/* Logo voeg nog extra code aan toe zodat je op de img klink dat je naar de home page */}
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          ...
                          "rounded-md px-4 py-3 text-ls font-medium"
                        )}
          ...
          <DisclosurePanel className="sm:hidden">
            <div className="space-y-2 px-1 pb-3 pt-2">
              {navigation.map((item) => (
                <DisclosureButton
                  key={item.name}
                  as="a"
                  ...
                  className={classNames(
                    item.current
                      ? "bg-gray-900 text-white"
                      : "text-gray-300 hover:bg-gray-700 hover:text-white",
                    "block rounded-md px-3.5 py-2.5 text-base font-medium text-ml"
                  )}
                  aria-current={item.current ? "page" : undefined}
                >
                  {item.name}
