...
/*            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.BoekingId);
                    table.ForeignKey(
...
/*            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarPicture = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CarPictures = table.Column<string>(type: "nvarchar(max)", nullable: true),
